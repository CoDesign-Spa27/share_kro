            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <a
                  ...
                  className="bg-white w-9 h-9 rounded-full flex items-center my-2 justify-center text-black text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none "
                >
