          ...
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              ...
              <div className='relative h-full'>
               ...
               <button
               type='button'
               className='absolute bottom-3 right-3 p-3 rounded-full bg-[#00afb9] text-white text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
