...
const navigate =useNavigate();
  return (
    ...
    >
      {fields && (<p className='text-red-500 mb-5 text-xl transition-all duration-100 ease-in'>
      Please fill in all the fields.
      </p>)}
         <div className='flex lg:flex-row flex-col justify-center items-center  lg:p-5 p-3 lg:w-4/5 w-full '>
          <div className='bg-secondaryColor p-3 flex flex-0.7 rounded-md w-full'>
          <div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  <div className='flex flex-col items-center justify-center'>
                    <p className='font-bold text-2xl  dark:text-black  '>
                      <AiOutlineCloudUpload />
                    </p>
                    <p className='text-lg dark:text-black '>Click to upload</p>
                  </div>
              ...
              <div className='relative h-full'>
               ...
               <button
               type='button'
               className='absolute bottom-3 right-3 p-3 rounded-full bg-[#00afb9]   text-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
         ...
         <div className='flex flex-col'> 
             <div>
              <p className='mb-2 font-semibold text-lg sm:text-xll'>Choose Pin Category</p>
              <select
